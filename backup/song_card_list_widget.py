...
from Groove.my_song_tab_interface.song_card import SongCard
...
class SongCardListWidget(ListWidget):
    ...
    def addListWidgetItem(self):
        ...
        for i in range(len(self.songInfo.songInfo_list)):
            ...
            songCard.resize(1150, 61)
            self.item.setSizeHint(QSize(songCard.width(), 61))
            self.addItem(self.item)
            self.setItemWidget(self.item, songCard)
