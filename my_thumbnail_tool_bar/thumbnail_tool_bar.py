...
class ThumbnailPlayButton(QWinThumbnailToolButton):
    ...
    def setPlay(self, isPlay: bool):
        ...
        if self.isPlaying:
            self.setToolTip('暂停')
            self.setIcon(
                QIcon(r'resource\images\thumbnail_tool_bar\播放_32_32_2.png'))
        else:
            self.setToolTip('播放')
            self.setIcon(
                QIcon(r'resource\images\thumbnail_tool_bar\暂停_32_32_2.png'))
...
class ThumbnailToolBar(QWinThumbnailToolBar):
    ...
    def __initWidget(self):
        ...
        self.lastSongButton.setIcon(
            QIcon(r'resource\images\thumbnail_tool_bar\上一首_32_32_2.png'))
        self.nextSongButton.setIcon(
            QIcon(r'resource\images\thumbnail_tool_bar\下一首_32_32_2.png'))
        # 将按钮添加到任务栏
