...
class SongTabSongCard(BasicSongCard):
    ...
    def __initWidget(self):
        ...
        self.addLabels([self.songerLabel, self.albumLabel,
                        self.yearLabel, self.tconLabel, self.durationLabel], [30, 15, 27, 19, 70])
        # 年份的宽度固定为60，时长固定距离窗口右边界45px
        self.setScalableWidgets([self.songNameCard, self.songerLabel,
                                 self.albumLabel, self.tconLabel], [326, 191, 191, 178], 105)
