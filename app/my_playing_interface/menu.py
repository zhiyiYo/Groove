...
class AddToMenu(QMenu):
    ...
    def createActions(self):
        ...
        self.playingAct = QAction(
            QIcon(r'app\resource\images\playing_interface\正在播放_white_17_17.png'), '正在播放', self)
        self.newPlayList = QAction(
            QIcon(r'app\resource\images\playing_interface\新的播放列表_20_20.png'), '新的播放列表', self)
        self.myLove = QAction(
            QIcon(r'app\resource\images\playing_interface\播放列表_white_20_20.png'), '我喜欢', self)
