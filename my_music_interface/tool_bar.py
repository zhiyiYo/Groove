...
class ToolBar(QWidget):
    ...
    def __createWidgets(self):
        ...
        self.songSortAction_list = [
            self.songSortByCratedTimeAct, self.songSortByDictOrderAct, self.songSortBySongerAct]
        self.albumSortAction_list = [
            self.albumSortByCratedTimeAct, self.albumSortByDictOrderAct,
            self.albumSortByYearAct, self.albumSortBySongerAct]
    ...
    def __setQss(self):
        """ 设置层叠样式 """
        with open('resource\\css\\myMusicInterfaceToolBar.qss', encoding='utf-8') as f:
