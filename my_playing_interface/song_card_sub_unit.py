...
class ButtonGroup(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.playButton = ToolButton(
            [r'resource\images\playing_interface\播放按钮_white_60_60.png',
             r'resource\images\playing_interface\播放按钮_green_60_60.png'], self)
        self.addToButton = ToolButton(
            [r'resource\images\playing_interface\添加到按钮_white_60_60.png',
             r'resource\images\playing_interface\添加到按钮_green_60_60.png'], self)
        # 初始化
        self.__initWidget()
