...
from my_widget.basic_selection_mode_bar import BasicButton, BasicSelectionModeBar,CheckAllButton
...
class SelectionModeBar(BasicSelectionModeBar):
    ...
    def __createButtons(self):
        ...
        self.renameButton = BasicButton(
            r'resource\images\selection_mode_bar\编辑信息_20_20.png', '重命名', self)
        self.pinToStartMenuButton = BasicButton(
            r'resource\images\selection_mode_bar\固定到开始菜单_20_20.png', '固定到"开始"菜单', self)
    ...
    def __initWidget(self):
        ...
        self.addButtons([self.cancelButton, self.playButton, self.nextToPlayButton,
                         self.addToButton, self.renameButton, self.pinToStartMenuButton,
