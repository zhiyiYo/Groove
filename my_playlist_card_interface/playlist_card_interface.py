...
from my_playlist_panel_interface.rename_playlist_panel import RenamePlaylistPanel
...
class PlaylistCardInterface(QWidget):
    ...
    def __createWidgets(self):
        ...
        self.createPlaylistButton = ThreeStateButton(
            {'normal': r'resource\images\playlist_card_interface\newPlaylist_normal.png',
             'hover': r'resource\images\playlist_card_interface\newPlaylist_hover.png',
             'pressed': r'resource\images\playlist_card_interface\newPlaylist_pressed.png'}, self, (129, 19))
        # 创建导航标签
    ...
    def __showRenamePlaylistPanel(self, oldPlaylist: dict, playlistCard: PlaylistCard = None):
        ...
        renamePlaylistPanel.renamePlaylistSig.connect(
            lambda oldPlaylist, newPlaylist: self.__renamePlaylistSlot(oldPlaylist, newPlaylist, playlistCard))
